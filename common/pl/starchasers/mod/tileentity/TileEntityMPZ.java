...
public class TileEntityMPZ extends TileEntity {
		...
		if (item == null) {
			...
			if (!par1World.isRemote)
				par1World.spawnEntityInWorld(new EntityItem(par1World,
						par5EntityPlayer.posX, par5EntityPlayer.posY,
						par5EntityPlayer.posZ, item));
			item = null;
		}
	...
	/*
	 * @Override public void updateEntity() { if(tick>=Long.MAX_VALUE) tick = 0;
	 * if(tick%20 == 0) tick++; super.updateEntity();
	 * 
	 * }
	 */
}
